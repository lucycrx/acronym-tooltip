...
(function () {
  ...
  const TOOLTIP_CSS = `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .act-def-text { color: #09090b; line-height: 1.5; font-size: 14px; }
    .act-votes {
    ...
    .act-other-defs { padding: 0 20px; margin-top: 10px; }
    ...
    .act-def-row p { font-size: 14px; color: #71717a; line-height: 1.4; }
